...
function crearCardCarrera(carrera) {
    ...
    const duracion = carrera.duracion_meses ? carrera.duracion_meses + ' meses' : '';
    return `
        <div class="card">
            <div class="card-header">
                <div>
...
function crearCardCarreraModerna(carrera, categoria) {
    ...
    const duracion = carrera.duracion_meses ? carrera.duracion_meses + ' meses' : 'Según plan de estudios';
                    ...
                    <div class="detalle-seccion">
                        ...
                        <div class="detalle-info-grid">
                            <div class="detalle-info-item">
                                <i class="fas fa-clock"></i>
                                <span>${data.duracion_meses ? data.duracion_meses + ' meses' : 'Según plan de estudios'}</span>
                            </div>
                            <div class="detalle-info-item">
